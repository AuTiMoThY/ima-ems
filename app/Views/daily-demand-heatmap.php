...
<!-- 頁面內容  START-->
<!-- =========================================================================-->
<main class="page_main page-daily_demand_heatmap" id="DailyDemandHeatmapApp">

    <section class="page_section daily_demand_heatmap__query">
        <div class="page_section-inner">
            <div class="page_section-content container">
                <div class="daily_demand_heatmap__query-wrapper">
    ...
    <section class="page_section daily_demand_heatmap__chart">
        <div class="page_section-inner">
            <div class="page_section-content container-fluid">
                <div class="daily_demand_heatmap__chart-wrapper">
                        ...
                        <div class="imaems_panel-bd">
                            <div class="search_result chart-block " style="position: relative; overflow: hidden; width: 100%;">
                                <div class="chart-info text-center" v-if="isResult">
                                    <p class="txt txt-H3">從 {{date}} 開始的 {{day}} 天<br>最高需量為：{{max_date}}</p>
                                ...
                                <div class="search_result-title text-center txt-H3" v-if="isResult">
...
<script type="module" src="<?= js_url('page/daily-demand-heatmap.js?v=' . WEB_VERSION) ?>"></script>
<?= $this->endSection() ?>