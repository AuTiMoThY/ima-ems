...
<!-- 頁面內容  START-->
<!-- =========================================================================-->
<main class="page_main page-daily_usage_heatmap" id="DailyUsageHeatmapApp">

    <section class="page_section daily_usage_heatmap__query">
        <div class="page_section-inner">
            <div class="page_section-content container">
                <div class="daily_usage_heatmap__query-wrapper">
                        ...
                        <div class="imaems_panel-bd">
                            <form action="" class="imaems_frm query_frm" @submit.prevent="handleSubmit($event)">
                                ...
                                <div class="imaems_frm-bd">
                                    ...
                                    <section class="form-group row">
                                        <div class="col-12">
                                            <input-field label="日期" id="date" v-model="date" class="date_field" :isrequired="1" placeholder="請輸入日期" :error="fieldErrors.date"></input-field>
                                        </div>
                                    </section>
                                    <section class="form-group row">
                                        <div class="col-12">
    ...
    <section class="page_section daily_usage_heatmap__chart">
        <div class="page_section-inner">
            <div class="page_section-content container-fluid">
                <div class="daily_usage_heatmap__chart-wrapper">
                        ...
                        <div class="imaems_panel-bd">
                            <div class="search_result chart-block " style="position: relative; overflow: hidden; width: 100%;">
                                <div class="chart-info text-center" v-if="isResult">
                                    <p class="txt txt-H3">從 {{date}} 開始的 {{day}} 天，總用電度數為：{{total_usage}}</p>
...
<script type="module" src="<?= js_url('page/daily-usage-heatmap.js?v=' . WEB_VERSION) ?>"></script>
<?= $this->endSection() ?>