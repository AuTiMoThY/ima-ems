...
abstract class BaseController extends Controller
{
    ...
    public $placeData = null;
    public $parameterOptions = null;
    ...
    public function renderView($viewName, $page_title)
    {
        $this->memberInfo = $this->session->get('member_info');
        $this->placeData = $this->session->get('place_array');
        $this->parameterOptions = $this->session->get('parameterOptions');
